...
export default function LoginPage() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center">
      <div
        className="w-full h-full opacity-20 pointer-events-none animate-parallax absolute inset-0"
        style={{
      ...
      <div className="relative flex flex-col items-center bg-transparent">
        <div className="-z-10 bg-transparent mb-4">
          <Image
            src={`/website_banner_light.png`}
        ...
        <p className="text-primary text-xl ">
          An App for Creating Battle Decks
        </p>
        <div className=" mr-8">
